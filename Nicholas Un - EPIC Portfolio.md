...
-  Sort Review - https://github.com/EPIC-Campus-LPS/sort-review-nick-and-jakob
	- In this project, various partners and I coded multiple different sorting algorithms, then compared their runtimes.
	- We practiced Sorting Algorithms, and learned about Runtime Efficiency.
    - We also learned about applying JavaDoc Comments and generating a JavaDoc HTML, which would be applied going forwards.
-  Reverse Polish Notation - https://github.com/EPIC-Campus-LPS/reverse-polish-notation-the-goats
	- In this project, a partner and I coded operations to convert to postfix notation and solve postfix notation.
	- We practiced using Stacks and Queues, and learned about Prefix, Postfix, and Infix Notation.
-  Double Linked List - https://github.com/EPIC-Campus-LPS/doubly-linked-list-nicholas-shortlastname
	- In this project, I coded a class that emulated the functionality of a Doubly-Linked List
    - I practiced using Objects, Elements, Nodes, and Node references.
    - I also learned about JUnit Testing, Code Coverage, and Edge Cases, which would be applied going forwards.
-  Radix Sort - https://github.com/EPIC-Campus-LPS/radix-sort-nicholas-shortlastname
	- In this project, I coded the Radix Sorting Algorithm.
	- I practiced String Operations and Sorting Algorithms, and learned about Radix Sort, reading files, and writing to files.
